...
export async function createLocation(name: string, address?: string, requestModifiers?: RequestModifiers, sessionId?: string) {
...
export async function updateLocation(locationUuid: string, name?: string, address?: string, requestModifiers?: RequestModifiers, sessionId?: string) {
